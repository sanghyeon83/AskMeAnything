...
> ⚠️ **윈도우 구성 재구축 (2026-09-07)**: 8월 이관 때 껐던 윈도우 원격제어를 다시 세웠다.
> **§2·§5·§6의 `.vbs` 구성(세션 9개 일괄 기동, `--resume` 고정 핀, UTF-16LE 요구)은 폐기됐다.**
> 지금은 `.vbs` → `start-hidden.ps1` → 세션 1개 구조이고 핀을 쓰지 않는다.
> 나머지(§3 `-c` 금지, §4 판별법, §10 핀 관리 습관)는 여전히 유효하다.
> **[2026-09-07_윈도우-원격제어-재구축.md](2026-09-07_윈도우-원격제어-재구축.md)를 먼저 볼 것.**
